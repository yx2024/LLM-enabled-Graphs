...
class GAT(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = GATConv(1, 32, heads=16, concat=True)
        self.conv2 = GATConv(32 * 16, 64, heads=16, concat=True)
        self.conv3 = GATConv(64 * 16, 64, heads=16, concat=True)
        self.fc1 = torch.nn.Linear(64 * 16 * 2, 64)
        self.fc2 = torch.nn.Linear(64, 1)

        self.path_fc = torch.nn.Linear(64 * 16, 6)
    ...
    def forward(self, data):
        ...
        energy_output = F.softplus(energy_output)
